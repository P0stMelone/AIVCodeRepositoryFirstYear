    ...
    public class SpriteRenderer : Component, IDrawable {
        ...
        public Vector2 CenterOffset {
            get {
                ...
                temp.X = (0.5f - pivot.X) * Width * transform.Scale.X;
                temp.Y = (0.5f - pivot.Y) * Height * transform.Scale.Y;
                return temp;
            }
        }
        ...
        public Vector2 TopLeft {
            get {
                return transform.Position - new Vector2(Width * pivot.X * transform.Scale.X, 
                    Height * pivot.Y  * transform.Scale.Y);
            }
        }
        public Vector2 BottomRight {
            get {
                return transform.Position + new Vector2(Width * (1 - pivot.X) * transform.Scale.X, 
                    Height * (1 - pivot.Y) * transform.Scale.Y);
            }
        }
