...
namespace Aiv.Fast2D.Component {
    ...
    class Program {
        ...
        static void Main(string[] args) {
            ...
            Game.Init(1280, 720, "SpaceShooter", new PlayScene(), 720, 12);
            Game.Play();
        }
    ...
    public struct TilesetInfo {
        ...
        public void OpenXDocument(string filePath) {
            ...
            layerTiles = new int[layerWidth, layerHeight];
            int counter = 0;
            XElement data = layer.Element("data");
            foreach(XElement tile in data.Elements("tile")) {
                layerTiles[counter % layerWidth, counter / layerWidth] = (int)tile.Attribute("gid");
                counter++;
            }
