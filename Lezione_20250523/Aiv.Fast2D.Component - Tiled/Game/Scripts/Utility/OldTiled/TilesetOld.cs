...
namespace Aiv.Tiled {
    public class TilesetOld {
        ...
        public TilesetOld(Texture tex, int tileWidth, int tileHeight, int firstgid, int columns) {
            Source = tex;
            TileWidth = tileWidth;
        ...
        public TilesetOld(string textureName, int tileWidth, int tileHeight, int firstgid, int columns) {
