...
namespace SquareInvaders {
    public class Player {
        ...
        public Player (Vector2 pos, int width, int height, Color col, BulletPooler pooler) {
            this.pooler = pooler;
            position = pos;
            this.width = width;
            this.height = height;
            ...
            //base
            playerVisual[0] = new Rect(position.X - width / 2, position.Y - height / 2,
                width, height / 2, col);
            int cannonWidth = width / 2;
            //cannon
            playerVisual[1] = new Rect(position.X - cannonWidth / 2, position.Y - height,
