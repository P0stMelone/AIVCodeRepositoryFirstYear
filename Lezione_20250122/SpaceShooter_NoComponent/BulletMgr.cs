...
namespace SpaceShooter_NoComponent {
    public static class BulletMgr {
        ...
        public static void Init () {
            ...
            Texture greenGlobeTexture = new Texture("Assets/greenGlobe.png");
            Texture fireGlobeTexture = new Texture("Assets/fireGlobe.png");
                ...
                for (int j = 0; j < poolSize; j++) {
                    ...
                    switch (i) {
                        case (int)BulletType.FireGlobe:
                            b = new FireGlobe(fireGlobeTexture);
                            break;
                        case (int)BulletType.GreenGlobe:
                            b = new GreenGlobe(greenGlobeTexture);
                            break;
                        case (int)BulletType.BlueLaser:
                            b = new BlueLaser(blueLaserTexture);
                            break;
                        default:
                            b = new IceGlobe(fireGlobeTexture);
                            break;
                    }
                    bullets[i].Enqueue(b);
