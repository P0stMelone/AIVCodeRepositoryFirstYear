...
namespace Ragioniamo {
    ...
    class Class_B : Class_A {
        ...
        public override void AbstractMethod() {
            Console.WriteLine("AbstractMethod Class_B");
        }
    }
    ...
    class Class_E : Class_D {
        ...
        public override void AbstractMethod() {
            Console.WriteLine("AbstractMethod Class_E");
        }
    }

    class Class_F : Class_A {
        public override void AbstractMethod() {
            Console.WriteLine("AbstractMethod Class_F");
        }
    }


    public static class Usage {
        public static void MainDeiPoveri() {
