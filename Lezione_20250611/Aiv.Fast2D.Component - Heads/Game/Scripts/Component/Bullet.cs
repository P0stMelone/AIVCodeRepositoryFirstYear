...
namespace Aiv.Fast2D.Component {
    public class Bullet : UserComponent, IDamagable {
        ...
        public override void OnCollide(Collision collisionInfo) {
            IDamagable damagable = collisionInfo.Collider.GetComponent<IDamagable>();
            if (damagable != null) {
                damagable.TakeDamage(new DamageContainer(damage, transform.Position, gameObject));
            }
            DespawnMe();
        }
