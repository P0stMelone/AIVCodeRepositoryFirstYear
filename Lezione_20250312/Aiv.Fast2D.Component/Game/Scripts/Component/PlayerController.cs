...
namespace Aiv.Fast2D.Component {
    public class PlayerController : UserComponent {
        ...
        public override void Awake() {
            ...
            Console.WriteLine("Il deltatime al caricamento della scena è: " + Game.DeltaTime +
                " mentre il deltatime vero sarebbe: " + Game.Win.DeltaTime);
        }
        ...
        public override void Update () {
            Console.WriteLine(Game.Win.DeltaTime);
            HandleMovement();
            HandleShoot();
        }
