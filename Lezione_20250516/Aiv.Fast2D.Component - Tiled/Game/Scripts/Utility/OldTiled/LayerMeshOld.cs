...
";
        ...
        private LayerOld layer;

        public LayerMeshOld(LayerOld layer, TilesetOld tileset, int tileWidth, int tileHeight)
        {
        ...
        private int SetUVAt(float[] uvs, int index, float left, float top, bool flipH = false, bool flipV = false)
        {
        ...
        private float[] ComputeUVs()
        {
            ...
            for (int tileY = 0; tileY < height; tileY++)
            {
                for (int tileX = 0; tileX < width; tileX++)
                {
                    ...
                    index = SetUVAt(uvs, index, left, top, layer.Tiles[tileX, tileY].HorizontalFlip, layer.Tiles[tileX,tileY].VerticalFlip);
                }
            }
