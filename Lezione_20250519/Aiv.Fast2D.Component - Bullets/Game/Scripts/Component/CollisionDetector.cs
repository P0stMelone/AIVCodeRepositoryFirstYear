...
namespace Aiv.Fast2D.Component {
    public class CollisionDetector : UserComponent {
        ...
        protected void HandleGroundCollision(Collision collisionInfo) {
        ...
        protected bool IsHorizontalCollision (Collision collisionInfo) {
            return collisionInfo.Delta.X < collisionInfo.Delta.Y;
        }
